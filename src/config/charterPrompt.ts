/**
 * Default Schema Quality Charter Prompt
 * This is the full underlying text used by the schema engine
 * to enforce global quality rules across all domains.
 * 
 * Sourced from docs/schema-quality-charter.md
 */
export const DEFAULT_CHARTER_PROMPT = `# NeameGraph – Schema Quality Charter
